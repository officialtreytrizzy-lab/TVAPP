    ...
    <div className="min-h-dvh bg-slate-950 text-slate-100">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:py-28 text-center">
          <div className="mx-auto mb-5 inline-flex items-center gap-2 rounded-full border border-violet-500/30 bg-violet-500/10 px-4 py-1.5 text-xs font-medium text-violet-200"><Sparkles className="h-3.5 w-3.5" /> Real in-browser object removal</div>
      ...
      <footer className="border-t border-slate-800 bg-slate-950">
        ...
        <div className="border-t border-slate-800 px-4 py-5 pb-safe text-center text-xs text-slate-500">© {year} EraserAI. Only edit videos you own or have permission to edit.</div>
      </footer>
