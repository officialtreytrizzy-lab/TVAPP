...
import { Download, Film, Loader2, Music2, Play, Sparkles, Type, Upload, Volume2 } from 'lucide-react';
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <button
                onClick={() => {
                  setProject((prev) => ({
                    ...prev,
                    clips: prev.clips.map((clip) => (clip.id === selectedClip.id ? { ...clip, speed: selectedClip.speed === 1 ? 1.5 : 1 } : clip)),
                  }));
                }}
                className="rounded-full bg-white/[0.08] px-3 py-2 text-xs font-bold ring-1 ring-white/10"
              >
